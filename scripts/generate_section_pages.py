...
# ----- /company/index.html is generated by build_unified_company.py
#       (single long page with all 6 ex-subpages merged inline). Removed
#       from here to avoid the card-grid version overwriting it. -----
